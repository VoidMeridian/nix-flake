...
in {
  ...
  home.packages = with pkgs; [pure-prompt jetbrains.rust-rover keepassxc discord pavucontrol qpwgraph krisp-patcher metacopy network-reset prismlauncher nix-clean] ++ lib.optionals config.hyprland.enable [swaybg swayimg];
}
